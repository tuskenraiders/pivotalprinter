...
Gem::Specification.new do |s|
  ...
  s.files = ["History.txt", "Manifest.txt", "PostInstall.txt", "README.rdoc", "Rakefile", "bin/pivotalprinter", "images/bug.png", "images/chore.png", "images/feature.png", "images/release.png", "lib/pivotalprinter.rb", "pivotalprinter.gemspec", "script/console", "script/destroy", "script/generate", "test/test_helper.rb", "test/test_pivotalprinter.rb"]
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      ...
      s.add_runtime_dependency(%q<spruz>, ["~> 0.2.0"])
      ...
      s.add_dependency(%q<spruz>, ["~> 0.2.0"])
